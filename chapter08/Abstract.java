...
2. 추상 클래스 특징
    ...
    2) 하나 이상의 추상 메서드를 포함
    3) 확장성 제공을 위해 사용
        -> 자식 클래스들이 공통된 기능을 공유 + 고유 기능을 구현하도록 강제(오버라이딩을 강제)
    4) 다중 상속이 불가능 -> 하나의 extends 만 가능
...
class Student extends Human {
    ...
    @Override
    void work() {
        System.out.println("학생도 공부를 합니다.");
    }
}
...
class Dog extends Animal {
    ...
    @Override
    void eat() {
        System.out.println("강아지는 껌을 먹습니다.");
    }
}
...
//        Animal animal = new Animal(); - Error : 'Animal' is abstract; cannot be instantiated
        ...
        dog.eat();      // 강아지는 껌을 먹습니다. -> 자식 클래스에서 오버라이딩된 기능
    }
}
