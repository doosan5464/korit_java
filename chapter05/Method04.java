...
cf) 클래스의 "필드"
    ...
    클래스의 "메서드"
        : 인스턴스 메서드 vs 정적(클래스, static) 메서드

            - 인스턴스 메서드 : 객체(인스턴스)를 생성한 후 호출할 수 있는 메서드
            - 정적(클래스, static) 메서드 : 객체 생성 없이 호출 가능한 메서드
...
public class Method04 {
    public static void main(String[] args) {
        ...
        System.out.println("=== 인스턴스 메서드 ===");
        int result1 = Operator.multiply(20,10);
        int result2 = Operator.divide(20,10);
        int result3 = Operator.divide(20,0);
        System.out.println(result1); // 200
        System.out.println(result2); // 2
        System.out.println(result3); // 0
//        System.out.println(Operator.multiply(4,2)); // 8
//        System.out.println(Operator.divide(4,2)); // 2
    }
}
