...
public class C_ListPractice {
    public static void main(String[] args) {
        ...
        eventManagement.addToWaiting("윤대휘");
        eventManagement.addToWaiting("김소빈");
        eventManagement.addToWaiting("정규민");
        eventManagement.addToWaiting("박성욱");
