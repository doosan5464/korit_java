...
- 중간 삽입/삭제 시 : 데이터 이동이 필요하므로 상대적으로 성능 저하
    ...
    새 책을 책장의 중간에 추가할 경우 - 책을 모두 한 칸씩 옮겨야 함 (시간이 오래 걸림)
...
public class B_List {
    public static void main(String[] args) {
        ...
        // .add() 데이터 추가
        arrayList.add("Java"); // List 끝에 요소 추가
        ...
        // .set() 데이터 수정(느리지 않음. 인덱스번호는 그대로라서)
        ...
        // - 객체 데이터 타입 : Integer, Character, Boolean O
        ...
        // ArrayList 삽입 시간 : 353837500ns - 9자리
        ...
        // LinkedList 삽입 시간 : 3177800ns - 7자리
    }
}
