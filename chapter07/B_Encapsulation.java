...
>> 데이터 보호, 유지보수성, 사용자 편의성 증대

- 데이터 보호와 유지보수성 향상을 목적으로 데이터 필드(속성)를 private 로 선언
    & 데이터에 접근하거나 수정할 때는 getter 와 setter 메서드를 사용하게 하는 체계
...
class Student {
    ...
    // cf) setter 의 경우
    // 입력 값의 유효성을 검사하여 데이터의 일관성을 유지할 수 있음
...
public class B_Encapsulation {
    public static void main(String[] args) {
        ...
        // student.name = "이승아"; - Error. name은 private니까
