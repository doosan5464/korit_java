...
public class Exception02 {
    ...
    // : 호출자에게 예외 처리를 위임
    static void login(String username, String password) throws InvalidException {
        if(!"admin".equals(username)) {
            throw new InvalidException("사용자 이름이 잘못되었습니다.");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("정수가 아닌 다른 타입의 입력.");
        } finally {
            scanner.close();
        }
