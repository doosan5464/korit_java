...
public class C_OOP {
    public static void main(String[] args) {
        // CreditCardPaymentProcess를 결제 처리기로 선택
//        PaymentProcessor paymentProcessor = new CreditCardPaymentProcessor();

        //PdfReportGenerate를 보고소 생성기로 선택
//        GenerateReport generateReport = new PdfReport();

        OrderService orderService = new OrderService(new CreditCardPaymentProcessor(), new PdfReport());
