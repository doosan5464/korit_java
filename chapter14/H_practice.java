...
public class H_practice {
    public static void main(String[] args) {
        ...
        List<StudentClasss> studentClasses = Arrays.asList(
                new StudentClasss("이승아", 29, 4.3),
                new StudentClasss("이도경", 33, 4.1),
                new StudentClasss("이지훈", 20, 3.8),
                new StudentClasss("이지희", 25, 3.5)
        );
...
//        StudentClass(name=이승아, age=29, grade=4.3)
        ...
        List<StudentClasss> studentsWithJi = studentClasses.stream()
