...
public class A_Generic {
    public static void main(String[] args) {
        ...
        // boolean >> Boolean
        // char >> Character
        Pair<String, Integer> pair1 = new Pair<>("안녕하세요", 123);
        Pair<Integer, String> pair2 = new Pair<>(123, "안녕하세요");

        System.out.println(pair1.getKey()); // 안녕하세요
        System.out.println(pair2.getKey()); // 123
